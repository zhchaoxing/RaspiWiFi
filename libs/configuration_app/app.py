...
def set_ap_client_mode():
    ...
    os.system('[/etc/dnsmasq.conf.original] && mv /etc/dnsmasq.conf.original /etc/dnsmasq.conf || rm /etc/dnsmasq.conf')
    os.system(' [-f /etc/hcpcd.conf.original] && mv /etc/dhcpcd.conf.original /etc/dhcpcd.conf || rm /etc/dhcpcd.conf')
